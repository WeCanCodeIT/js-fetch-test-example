...
parcelRequire = function (e, r, n, t) {
  ...
  "LVu9": [function (require, module, exports) {
    var t = function t(_t) {
      return fetch("https://swapi.co/api/people/".concat(_t));
    };
  ...
  "Focm": [function (require, module, exports) {
    var e = require("./api"),
        t = e.getStarWarsPerson;

    state = {}, t(22).then(function (e) {
      return state.bobaFett = e.json();
    });
    var a = document.querySelector("#app"),
        n = document.createElement("main"),
        r = document.createElement("article");
    n.appendChild(r), a.appendChild(n), r.innerHTML = "\n    <h2>".concat(state.bobaFett.name, "</h2>\n"), console.log(state.bobaFett);
  }, {
    "./api": "LVu9"
  }]
}, {}, ["Focm"], null);
